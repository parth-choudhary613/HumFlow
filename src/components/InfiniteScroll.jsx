...
export default function InfiniteScroll({
  ...
  const getTiltTransform = () => {
    ...
    return tiltDirection === 'left'
      ? 'rotateX(0deg) rotateZ(0deg) skewX(0deg)'
      : 'rotateX(0deg) rotateZ(0deg) skewX(0deg)';
  };
  ...
  return (
    <div
      ...
      style={{ maxHeight }}
    >
      <div className="absolute top-0 left-0 w-full h-1/6 bg-gradient-to-b from-black to-transparent z-10 pointer-events-none"></div>
